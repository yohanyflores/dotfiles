...
create_symlink "$DOTFILES_DIR/scripts/git-ai-commit-zellij.sh" "$HOME/.local/bin/git-ai-commit-zellij"
create_symlink "$DOTFILES_DIR/scripts/git-ai-commit-config-zellij.sh" "$HOME/.local/bin/git-ai-commit-config-zellij"
